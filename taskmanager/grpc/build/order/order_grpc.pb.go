...
type OrderServiceClient interface {
	...
	ApproveOrder(ctx context.Context, in *ApprovalRequest, opts ...grpc.CallOption) (*Approval, error)
}
...
func (c *orderServiceClient) GetOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*Order, error) {
	out := new(Order)
	err := c.cc.Invoke(ctx, "/order.OrderService/get_order", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderServiceClient) ApproveOrder(ctx context.Context, in *ApprovalRequest, opts ...grpc.CallOption) (*Approval, error) {
	out := new(Approval)
	err := c.cc.Invoke(ctx, "/order.OrderService/approve_order", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	ApproveOrder(context.Context, *ApprovalRequest) (*Approval, error)
...
func (UnimplementedOrderServiceServer) ApproveOrder(context.Context, *ApprovalRequest) (*Approval, error) {
...
func _OrderService_GetOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/order.OrderService/get_order",
	}
...
func _OrderService_ApproveOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/order.OrderService/approve_order",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ApproveOrder(ctx, req.(*ApprovalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
